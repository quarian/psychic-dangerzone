...
synkronoinnin tarpeen vähentäminen ja menetelmien optimointi. Näillä keinoilla
...
\subsection{Videokoodauksen rinnakkaistamisen ongelmat}
\label{sec:problems}
...
olevaan HEVC-standardiin (High Efficiency Video Coding) on sisällytetty rinnakkaisuutta ja sille ehdotettua
...
Ongelmista huolimatta rinnakkaislaskennasta on tutkimusten mukaan hyötyä
