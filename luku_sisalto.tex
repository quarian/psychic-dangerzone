...
Videokoodausta käistellään luvussa \ref{chap:coding}. Luvussa esitellään
...
videodatan subjektiivisen laadun takia. Videodatan laatupiirteitä käsitellään
alaluvussa \ref{sec:quality}. Videon koodaamisen kannalta tärkeää on, että videodatan laatua
voidaan pakatessa menettää ilman, että ihmissilmä havaitsee laadun
heikkenemistä. Pakkaaminen on tällöin tehokkaampaa kuin laatu säilytettäessä. (\citealt{h264})
...
kyselytutkimuksella. Eräs tutkimus on parantanut videodatan
...
\subsection{SIMD, MIMD ja SIMT - rinnakkaisten menetelmien hallintarakenteet}
...
kaikillarinnakkaisilla laskenta-alustoilla.
\end{comment}
