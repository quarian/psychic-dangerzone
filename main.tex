...
\title{Videokoodauksen rinnakkaistaminen}
% 2-osainen otsikko:
...
\ENINSTRUCTOR{Vesa Hirvisalo, D.Sc.}
% M.Sc. (Tech)  // M.Sc. (Eng)
% Lic.Sc. (Tech)
...
\KEYWORDS{videokoodaus, enkoodaus, dekoodaus, transkoodaus, rinnakkaisohjelmointi, %
rinnakkainen videokoodaus, rinnakkaislaskenta}
\ENKEYWORDS{video coding, encoding, transcoding, parallel programming, %
parallel video coding, parallel computing}
...
\PAGES{25}  % kaikki sivut laskettuna nimiölehdestä lähdeluettelon tai 
...
% MINU HUOM! Otettu lyhenteet pois
...
% MINU HUOM! Liitteet toistaiseksi otettu pois
